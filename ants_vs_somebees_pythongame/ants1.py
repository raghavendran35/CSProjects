    ...
    def add_insect(self, insect):
        ...
        if insect.is_ant:
            if self.ant is None:
                ...
                # BEGIN Problem 11
                assert Ant.can_contain(self.ant, insect) or Ant.can_contain(insect,self.ant), 'Two ants in {0}'.format(self)
                if Ant.can_contain(self.ant,insect):
                    self.ant.ant = insect

                if Ant.can_contain(insect,self.ant):
                    insect.ant = self.ant
                    self.ant = insect
...
class Ant(Insect):
    ...
    def can_contain(self, other):
        ...
        #return not self.ant and self.container and not other.container
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive, min_range = 0, max_range = 10000):
        ...
        #minimum_range = 
        my_place = self.place
        for path in range(min_range):
            my_place = my_place.entrance
        rangecount = 0
        while True:
            if my_place == hive or rangecount > max_range:
                return None
        ...
        if self.impostor == True:
            ...
            while my_place:
                if my_place.ant:
                    ...
                    if my_place.ant.container and not my_place.ant.buffed:
                        my_place.ant.ant.damage*=2
                        #checking for characteristics of container
